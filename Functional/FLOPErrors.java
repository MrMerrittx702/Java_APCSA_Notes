...
/**
*Notes:
* Floating point errors result from the way that computers do math. 
...
class FLOPErrors{
  public static void main(String[] args){
    ...
    System.out.println(notPointThree == 0.3);//returns false ?...
    System.out.println("0.2 + 0.1 = " + notPointThree + " ...What? That is not right...");

    //If you use a comparison operator with floating point numbers you may end up with an unintended error.
    //This can be difficult to understand. Lets look at how values are represented in decimal and in binary.
    ...
    */
    ...
    System.out.println("What about this 0.4 - 0.1 = " + (0.4 - 0.1));//interesting...

    //other examples
    System.out.println("Ok now try this 0.7 + 0.1 = " + (0.7 + 0.1));
    //0.7 --> 0.101100110011001100...
    //0.1 --> 0.000110011001100110...

    System.out.println("But what about this 0.9 - 0.1 = " + (0.9 - 0.1) + " What?!!! and here we go again...");
